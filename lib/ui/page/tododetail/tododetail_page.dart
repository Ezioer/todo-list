        ...
        actions: [
          IconButton(
              onPressed: () {
                ...
                Get.find<HomeController>().updateCount(Get.find<ListDetailController>().typeEntity, 4, controller.data.isFinish!, controller.data.isMark!, controller.data.type!);
        ...
        child: Column(
          ...
          children: [
                  ...
                  children: [
                    Checkbox(
                      onChanged: (value) {
                        ...
                        Get.find<HomeController>().updateCount(Get.find<ListDetailController>().typeEntity, 2, controller.data.isFinish!, 0, controller.data.type!);
                    ...
                    IconButton(
                      onPressed: () {
                        ...
                        Get.find<TodoDetailController>().updateTaskStatus(controller.data);
                        Get.find<HomeController>().updateCount(Get.find<ListDetailController>().typeEntity, 3, controller.data.isMark!, 0, controller.data.type!);
                        Get.find<TodoDetailController>().update();
                        Get.find<ListDetailController>().update();
                      },
                ...
                children: [
                  GetBuilder<TodoDetailController>(
                    builder: (_) => InputChip(
                      ...
                      label: Text(
                        "${DateUtil.getTimeNoti(controller.data.stopTime!)}",
                      ),
                      onPressed: () {
                                  ...
                                  ListTile(
                                    ...
                                    onTap: () async {
                                      ...
                                      if (newDate != null) {
                                        ...
                                        controller.data.stopTime = newDate.add(Duration(days: 1)).millisecondsSinceEpoch;
                                ...
                                children: [
                                  ...
                                  ListTile(
                                    ...
                                    onTap: () async {
                                      ...
                                      if (newDate != null) {
                                        controller.dateTime = newDate;
                                        controller.data.notiTime = newDate.subtract(Duration(hours: 5)).millisecondsSinceEpoch.toString();
            ...
            Container(
              ...
              child: Text(
                "${getTimeFromMill(controller.data.createTime!)}",
